...
def specs() -> dict[str, dict[str, Any]]:
    ...
    delivery_monitor_plan = [
        query("delivery_headers", "API_OUTBOUND_DELIVERY_SRV", "A_OutbDeliveryHeader", fields=["DeliveryDocument", "SalesOrganization", "ActualGoodsMovementDate", "OverallGoodsMovementStatus", "OverallDelivReltdBillgStatus", "DeliveryBlockReason", "HeaderBillingBlockReason", "PlannedGoodsIssueDate"], filters=[filt("SalesOrganization", "{{input.sales_organization}}"), filt("ActualGoodsMovementDate", "{{input.date_from}}", op="ge", kind="date_start"), filt("ActualGoodsMovementDate", "{{input.date_to}}", op="le", kind="date_end")], rationale="Load deliveries in the selected PGI period; the Embedded Provider follows server next links and reports paging completeness."),
        query("delivery_items", "API_OUTBOUND_DELIVERY_SRV", "A_OutbDeliveryItem", fields=["DeliveryDocument", "DeliveryDocumentItem", "ReferenceSDDocument", "ReferenceSDDocumentItem", "Plant", "Material", "ActualDeliveryQuantity", "DeliveryQuantityUnit", "GoodsMovementStatus", "DeliveryRelatedBillingStatus"], bindings=[bind("DeliveryDocument", "delivery_headers", "DeliveryDocument")], rationale="Load items for selected deliveries; deterministic output sorting is applied after complete retrieval because live metadata does not advertise delivery keys as sortable."),
        query("billing_items", "API_BILLING_DOCUMENT_SRV", "A_BillingDocumentItem", fields=["BillingDocument", "BillingDocumentItem", "ReferenceSDDocument", "ReferenceSDDocumentItem", "BillingQuantity", "BillingQuantityUnit", "NetAmount", "TransactionCurrency"], bindings=[bind("ReferenceSDDocument", "delivery_items", "DeliveryDocument"), bind("ReferenceSDDocumentItem", "delivery_items", "DeliveryDocumentItem")], order_by=["BillingDocument", "BillingDocumentItem"], rationale="Load billing items referencing selected delivery items."),
        query("billing_headers", "API_BILLING_DOCUMENT_SRV", "A_BillingDocument", fields=["BillingDocument", "BillingDocumentDate", "BillingDocumentIsCancelled", "CancelledBillingDocument", "BillingDocumentCategory"], bindings=[bind("BillingDocument", "billing_items", "BillingDocument")], order_by=["BillingDocument"], rationale="Load billing dates and cancellation relationships."),
        query("cancellation_documents_by_reference", "API_BILLING_DOCUMENT_SRV", "A_BillingDocument", fields=["BillingDocument", "BillingDocumentDate", "BillingDocumentIsCancelled", "CancelledBillingDocument", "BillingDocumentCategory"], bindings=[bind("BillingDocument", "billing_headers", "CancelledBillingDocument")], order_by=["BillingDocument"], rationale="Load cancellation documents referenced by billing headers."),
        query("cancellation_documents_by_target", "API_BILLING_DOCUMENT_SRV", "A_BillingDocument", fields=["BillingDocument", "BillingDocumentDate", "BillingDocumentIsCancelled", "CancelledBillingDocument", "BillingDocumentCategory"], bindings=[bind("CancelledBillingDocument", "billing_headers", "BillingDocument")], order_by=["BillingDocument"], rationale="Load cancellation documents that point back to billing headers."),
        query("source_sales_items", "API_SALES_ORDER_SRV", "A_SalesOrderItem", fields=["SalesOrder", "SalesOrderItem", "RequestedQuantity", "RequestedQuantityUnit", "NetAmount", "TransactionCurrency"], bindings=[bind("SalesOrder", "delivery_items", "ReferenceSDDocument"), bind("SalesOrderItem", "delivery_items", "ReferenceSDDocumentItem")], order_by=["SalesOrder", "SalesOrderItem"], rationale="Load source sales-order quantity and net amount evidence."),
    ]
    delivered_not_billed_inputs = deepcopy(organization_range)
    delivered_not_billed_inputs["properties"]["date_to"]["x-sapba-server-default"] = "business_date"
    result["delivered-not-billed"] = execution("delivered-not-billed", delivered_not_billed_inputs, [sap_step("collect_delivered_not_billed", delivery_monitor_plan, rationale="Collect delivered-not-billed evidence.")])
...
RELATIONSHIPS: list[tuple[str, tuple[str, str, str, str], tuple[str, str, str, str]]] = [
    ...
    ("sd-delivery-item-to-billing-reference-item", ("API_OUTBOUND_DELIVERY_SRV", "A_OutbDeliveryItem", "DeliveryDocumentItem", "delivery_document_item_id"), ("API_BILLING_DOCUMENT_SRV", "A_BillingDocumentItem", "ReferenceSDDocumentItem", "sd_reference_document_item_id")),
    ("sd-delivery-reference-to-sales-order", ("API_OUTBOUND_DELIVERY_SRV", "A_OutbDeliveryItem", "ReferenceSDDocument", "sd_reference_document_id"), ("API_SALES_ORDER_SRV", "A_SalesOrderItem", "SalesOrder", "sales_order_id")),
    ("sd-delivery-reference-item-to-sales-order-item", ("API_OUTBOUND_DELIVERY_SRV", "A_OutbDeliveryItem", "ReferenceSDDocumentItem", "sd_reference_document_item_id"), ("API_SALES_ORDER_SRV", "A_SalesOrderItem", "SalesOrderItem", "sales_order_item_id")),
    ("sd-billing-cancelled-document-reference", ("API_BILLING_DOCUMENT_SRV", "A_BillingDocument", "CancelledBillingDocument", "billing_document_id"), ("API_BILLING_DOCUMENT_SRV", "A_BillingDocument", "BillingDocument", "billing_document_id")),
    ("sd-billing-cancellation-back-reference", ("API_BILLING_DOCUMENT_SRV", "A_BillingDocument", "BillingDocument", "billing_document_id"), ("API_BILLING_DOCUMENT_SRV", "A_BillingDocument", "CancelledBillingDocument", "billing_document_id")),
