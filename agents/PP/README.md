...
区分MRP异常、销售需求/PIR覆盖、订单执行、数量偏差和产能；金额成本差异在CO模块，新增销售需求模拟在SD模块。

Distinguish MRP exceptions, sales/PIR coverage, execution, quantity variance and capacity. Monetary cost variance belongs to CO; new sales-demand simulation belongs to SD.
