...
- SAP GET：1；证据行计数：0；耗时：13702.991 ms
- 查询源完整：`false`；业务完整：`false`
- 错误代码：run_failed
- 证据 SHA-256：`e151d5b2f6e51a66f1c77f7abe132940718f3e0c501097f55ff2e2f72a618866`

## Step status

- Embedded API：`read_posting`=`complete`
- ADT：`adt_posting`=`skipped/condition_false`, `adt_cycle`=`failed/run_failed`, `adt_object`=`failed/run_failed`, `adt_settlement`=`skipped/condition_false`
...
- Missing evidence：allocation_cycle, allocation_cycle_evidence, object_status, object_status_evidence, settlement_rule
