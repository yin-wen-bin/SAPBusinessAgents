...
- 自然语言/结构化用例输入（脱敏）：`{}`
- Embedded服务与实体：`API_OUTBOUND_DELIVERY_SRV/A_OutbDeliveryHeader`, `API_SALES_ORDER_SRV/A_SalesOrder`, `API_SALES_ORDER_SRV/A_SalesOrderItem`, `API_SALES_ORDER_SRV/A_SalesOrderScheduleLine`
