# due-delivery-prioritization 真机测试报告
...
- 自然语言/结构化用例输入（脱敏）：`{}`
- Embedded服务与实体：`API_MATERIAL_STOCK_SRV/A_MatlStkInAcctMod`, `API_SALES_ORDER_SRV/A_SalesOrder`, `API_SALES_ORDER_SRV/A_SalesOrderItem`, `API_SALES_ORDER_SRV/A_SalesOrderScheduleLine`
