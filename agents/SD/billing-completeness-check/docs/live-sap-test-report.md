# billing-completeness-check 真机测试报告
...
- 自然语言/结构化用例输入（脱敏）：`{}`
- Embedded服务与实体：`API_BILLING_DOCUMENT_SRV/A_BillingDocument`, `API_BILLING_DOCUMENT_SRV/A_BillingDocumentItem`, `API_OUTBOUND_DELIVERY_SRV/A_OutbDeliveryItem`, `API_SALES_ORDER_SRV/A_SalesOrderItem`
