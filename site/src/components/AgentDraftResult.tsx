...
export default function AgentDraftResult({ run, trial, locale, runPath, apiBase }: { run: any; trial?: any; locale: Locale; runPath: string; apiBase: string }) {
